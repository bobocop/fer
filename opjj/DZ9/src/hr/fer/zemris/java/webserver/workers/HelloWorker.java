...
/**
 * Greets the user, displays the current date and time and if the
 * has sent the "name" parameter, counts the length of its value.
 */
public class HelloWorker implements IWebWorker {
	...
	public void processRequest(RequestContext context) {
		...
		try {
			...
			System.err.println("HelloWorker: could not write to the socket");
		}
	}
}
